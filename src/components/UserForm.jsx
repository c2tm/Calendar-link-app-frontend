...
const UserForm = ({route, mode, setUserInfo=null, setIsAuthorized=null}) => {
    ...
    return (
            <form className="user-form" onSubmit={handleSubmit}>
                ...
                <input type="password" name="password1" id="password1" onChange={(e) => setPassword1(e.target.value)} placeholder="Password" required/>
                {mode === "register" && <input type="password" name="password2" id="password2" onChange={(e) => setPassword2(e.target.value)} placeholder="Confirm Password" required/>}
